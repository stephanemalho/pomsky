...
export const faqHome: FAQItem[] = [
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          Royal POMSKY est un élevage spécialisé dans le Pomsky, avec une sélection rigoureuse
  ...
  {
    question: "Comment les chiots Pomsky sont-ils socialisés ?",
    answer: (
      <div className="space-y-3">
        <p>
...
export const faqNosChiots: FAQItem[] = [
  {
    question: "Comment sont préparés les chiots Pomsky avant leur départ ?",
    answer: (
      <div className="space-y-3">
        <p>
...
export const faqReproducteurs: FAQItem[] = [
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          Le Pomsky étant issu de lignées Husky et Spitz, la sélection des reproducteurs
...
export const faqPomsky: FAQItem[] = [
  {
    question: "Le Pomsky est-il proche de l'humain ?",
    answer: (
      <div className="space-y-3">
        <p>
