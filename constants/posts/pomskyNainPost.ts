import type { BlogPost } from "../blog/blogTypes";
...
export const pomskyNainPost: BlogPost = {
    ...
    introduction:
        "Le pomsky nain est un chien de plus en plus populaire auprès des amateurs de petites races. Issu du croisement entre un husky et un spitz nain, aussi appelé loulou de Poméranie, il combine les meilleures qualités de ses deux parents. Avec son apparence mignonne et son caractère attachant, il s'impose naturellement comme un excellent chien de compagnie.",
    sections: [
        {
            subtitle: "L'origine du pomsky nain",
            paragraphs: [
                "Le pomsky nain est une race relativement récente dans le monde canin. Il est né de l'idée de croiser deux races très différentes afin d'obtenir un chien harmonieux, à la fois robuste et compact.",
        ...
        {
            subtitle: "Caractère et personnalité du pomsky nain",
            paragraphs: [
                "Le pomsky nain est un chien intelligent, vif et très joueur. Il combine l'énergie du husky avec l'affection et la vivacité du spitz nain.",
        ...
        {
            subtitle: "Avoir un pomsky nain chez soi",
            paragraphs: [
                "Adopter un pomsky nain demande une préparation adaptée. Bien qu'il soit de petite taille, c'est un chien actif qui a besoin de se dépenser quotidiennement.",
        ...
        {
            subtitle: "La taille et l'apparence du pomsky nain",
            paragraphs: [
                "Le pomsky nain se distingue par sa taille très compacte. Il pèse généralement entre 3 et 5 kg et mesure environ 20 à 30 cm au garrot.",
        ...
        },
        {
            ...
            paragraphs: [
                "Comme tous les chiens, le pomsky nain nécessite un suivi vétérinaire régulier. Lorsqu'il est issu d'un élevage sérieux pratiquant les tests de santé (tares oculaires, articulations, ADN), il s'agit d'une race globalement robuste.",
                "La socialisation précoce est essentielle. Malgré sa petite taille, le pomsky nain doit interagir avec des chiens de gabarits variés afin de développer un comportement équilibré et confiant."
            ]
        },
        {
            subtitle: "Prix et acquisition d'un pomsky nain",
            paragraphs: [
                "Le pomsky nain est un chien rare, ce qui explique un coût d'acquisition élevé. Le prix peut varier entre 5 000 et 7 000 euros selon la qualité de l'élevage et les caractéristiques du chiot.",
        ...
        },
        {
            ...
            paragraphs: [
                "La popularité du pomsky nain attire malheureusement des pratiques peu scrupuleuses. Les annonces à prix très bas ou provenant de plateformes douteuses doivent éveiller la méfiance.",
        ...
        {
            subtitle:
                "Pourquoi choisir un pomsky nain comme chien de compagnie",
            paragraphs: [
                "Le pomsky nain représente un excellent compromis pour les personnes recherchant un chien de petite taille avec une forte personnalité.",
        ...
        {
            subtitle: "Les avantages d'avoir un pomsky nain",
            paragraphs: [
    ...
    author: {
        name: "Marine",
        role: "Éleveur de Pomsky pationnnée",
    ...
    imageAlt: "Pomsky nain au regard expressif et pelage dense",
    contactCta: {
