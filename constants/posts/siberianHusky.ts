...
export const huskySiberienPost: BlogPost = {
    ...
    sections: [
        {
            subtitle: "Origines et histoire du Husky Sibérien",
            paragraphs: [
        ...
        {
            subtitle: "Apparence physique du Husky Sibérien",
            paragraphs: [
        ...
        {
            subtitle: "Husky et Pomsky : des différences notables",
            paragraphs: [
        ...
        {
            subtitle: "Éducation du chien de traîneau",
            paragraphs: [
        ...
        {
            subtitle: "Mode de vie et besoins",
            paragraphs: [
        ...
        {
            subtitle: "Solitude et comportement",
            paragraphs: [
        ...
        {
            subtitle: "Santé et sélection des reproducteurs",
            paragraphs: [
    ...
    image: "/assets/blog/decouvrez-le-husky-siberian-1038x576.webp",
    imageAlt: "Husky Sibérien au regard intense et pelage épais",
    contactCta: {
