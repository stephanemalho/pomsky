...
export const pomskyGenerationsPost: BlogPost = {
    ...
    title: "Pomsky F1, F2, F3 : que signifient vraiment ces générations ?",
    seoTitle:
        "Pomsky F1, F2, F3 : explication claire des générations et de ce qu'elles changent",
    excerpt:
        "Les générations F1, F2 et F3 sont souvent citées dans les annonces, mais rarement bien expliquées. Voici ce qu'elles signifient vraiment et ce qu'elles changent dans la lecture d'un chiot Pomsky.",
    seoDescription:
        "Que signifient F1, F2 et F3 chez le Pomsky ? Découvrez comment lire les générations, ce qu'elles changent dans la stabilité du type et pourquoi elles comptent dans un élevage professionnel.",
    introduction:
        "Les termes F1, F2 ou F3 reviennent très souvent dans les annonces de Pomsky, parfois comme s'ils suffisaient à résumer tout le chien. En réalité, ces générations sont utiles, mais seulement si l'on comprend ce qu'elles décrivent et ce qu'elles ne disent pas à elles seules. Cet article est donc centré sur la lecture des générations: leur signification, ce qu'elles changent dans la construction de la race et pourquoi elles comptent dans un élevage professionnel sans devenir un raccourci simpliste.",
    modifiedDate: "2026-03-27",
    sections: [
        {
            subtitle: "Les générations décrivent une filiation, pas une qualité automatique",
            paragraphs: [
        ...
        {
            subtitle: "Pomsky F1 : la première génération",
            paragraphs: [
        ...
        {
            subtitle: "Pomsky F2 et F3 : vers plus de lisibilité",
            paragraphs: [
        ...
        {
            subtitle: "Ce que la génération change dans la lecture d'un chiot",
            paragraphs: [
        ...
        {
            subtitle: "Pourquoi les générations comptent dans un élevage professionnel",
            paragraphs: [
        ...
        {
            subtitle: "Ce qu'il faut retenir sur F1, F2 et F3",
            paragraphs: [
            ...
            links: [
                {
                    label: "Voir notre article sur le Pomsky comme race hybride",
