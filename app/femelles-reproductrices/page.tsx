...
const puppies: Puppy[] = [
    ...
    },
    {
        ...
        images: [
            "SHANE-pomsky-miniature-f3.webp",
        ],
    },
    {
        ...
        images: [
            "BEAUTY-pomsky-miniature-f4webp.webp",
        ],
    },
    {
        name: "ROYAL POMSKY 'AKASHA'",
        coat: "Pomsky F4 (ADN Poméranian / Husky)",
        color: "Chocolat et blanc",
        size: "Toy",
        ruler: "Fourrure : type wooly",
        weight: "Taille : 26 cm au garrot • Poids : 3 kg",
        description:
            "Akasha est une femelle Pomsky F4 de catégorie toy, née chez Royal Pomsky, à la robe chocolat et blanche et au regard bleu intense. Son format très compact et sa fourrure wooly lui donnent une allure délicate et raffinée, tout en conservant une belle expression husky. Proche de l'humain et bien équilibrée, elle présente un tempérament doux et serein. Sa morphologie fine et harmonieuse, associée à une excellente qualité de poil, en fait une femelle toy particulièrement élégante et représentative du type Pomsky recherché.",
        highlights: [
            "Femelle",
            "Format toy",
            "Masque Fleur de Lys",
    ...
    },
    {
        ...
        images: [
            "BAMBOU-pomsky-miniature-f5.webp",
        ],
    },
    {
