                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6 md:order-1">
                                ...
                                <Link
                                    ...
                                    className="flex items-center bg-primary h-auto min-h-10 text-white hover:bg-primary/80 px-4 font-semibold  dark:text-[#5b3a1a] rounded-md w-fit"
                    ...
                    <section className="mb-16 bg-muted/30 -mx-4 px-4 py-16 rounded-lg">
                        <div className="max-w-4xl mx-auto text-center space-y-6">
                            ...
                            <h3 className="text-2xl font-bold">
                                Un élevage professionnel en Bourgogne-Franche-Comté, dédié au Pomsky Toy américain
                            </h3>
                            <p className="text-muted-foreground leading-relaxed">
